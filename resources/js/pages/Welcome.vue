...
<template>
    ...
    >
        ...
        >
            ...
            <div class="mt-4 w-full max-w-[335px] lg:max-w-4xl">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                    <div class="grid grid-rows-[auto_1fr_auto] group relative overflow-hidden rounded-lg bg-gradient-to-br from-[#42b883]/10 to-[#35495e]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(66,184,131,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(66,184,131,0.5)] dark:from-[#42b883]/20 dark:to-[#35495e]/20">
                        <div class="mb-3 flex items-center gap-3">
                            <svg class="h-8 w-8" viewBox="0 0 256 221" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 class="text-lg font-semibold text-[#35495e] dark:text-[#42b883]">
                                Vue.js
                            </h3>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            The progressive JavaScript framework for building modern, reactive user interfaces. Vue 3 offers the Composition API, improved performance, and better TypeScript support.
                        </p>
                        <a
                            href="https://vuejs.org/guide/introduction.html"
                            target="_blank"
                            class="inline-flex items-center space-x-1 text-sm font-medium text-[#42b883] underline underline-offset-4 hover:text-[#35495e] dark:text-[#42b883] dark:hover:text-[#5fd89e]"
                        >
                            <span>Read Vue Documentation</span>
                            <svg
                                width="10"
                                height="11"
                                viewBox="0 0 10 11"
                    ...
                    <div class="grid grid-rows-[auto_1fr_auto] group relative overflow-hidden rounded-lg bg-gradient-to-br from-[#9553e9]/10 to-[#6c2bd9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(149,83,233,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(149,83,233,0.5)] dark:from-[#9553e9]/20 dark:to-[#6c2bd9]/20">
                        <div class="mb-3 flex items-center gap-3">
                            <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 128 128"><defs><linearGradient id="SVGqdAbMSVr" x1="0" x2="128" y1="64" y2="64" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#9553e9"/><stop offset="1" stop-color="#6d74ed"/></linearGradient></defs><path fill="url(#SVGqdAbMSVr)" d="M92.433 28.433H55.625L91.192 64L55.625 99.567h36.808L128 64zm-55.625 0H0L35.567 64L0 99.567h36.808L72.375 64z"/></svg>
                            <h3 class="text-lg font-semibold text-[#6c2bd9] dark:text-[#9553e9]">
                                Inertia.js
                            </h3>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            The modern monolith approach. Build single-page applications without the API complexity. Inertia seamlessly bridges Laravel and Vue with server-side routing.
                        </p>
                        <a
                            href="https://inertiajs.com/"
                            target="_blank"
                            class="inline-flex items-center space-x-1 text-sm font-medium text-[#9553e9] underline underline-offset-4 hover:text-[#6c2bd9] dark:text-[#9553e9] dark:hover:text-[#b17ef5]"
                        >
                            <span>Read Inertia Documentation</span>
                            <svg
                                width="10"
                                height="11"
                                viewBox="0 0 10 11"
                    ...
                    <div class="grid grid-rows-[auto_1fr_auto] group relative overflow-hidden rounded-lg bg-gradient-to-br from-[#06b6d4]/10 to-[#0ea5e9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(6,182,212,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(6,182,212,0.5)] dark:from-[#06b6d4]/20 dark:to-[#0ea5e9]/20">
                        <div class="mb-3 flex items-center gap-3">
                            <svg class="h-8 w-8" viewBox="0 0 256 154" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 class="text-lg font-semibold text-[#0ea5e9] dark:text-[#06b6d4]">
                                Tailwind CSS
                            </h3>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            A utility-first CSS framework for rapid UI development. Build custom designs without leaving your HTML. Tailwind 4 brings improved performance and native cascade layers.
                        </p>
                        <a
                            href="https://tailwindcss.com/docs"
                            target="_blank"
                            class="inline-flex items-center space-x-1 text-sm font-medium text-[#06b6d4] underline underline-offset-4 hover:text-[#0ea5e9] dark:text-[#06b6d4] dark:hover:text-[#22d3ee]"
                        >
                            <span>Read Tailwind Documentation</span>
                            <svg
                                width="10"
                                height="11"
                                viewBox="0 0 10 11"
