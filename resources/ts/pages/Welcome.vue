...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
        <div class="flex w-full flex-col items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
            ...
            <div class="mt-4 w-full max-w-[335px] lg:max-w-4xl">
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                    <div
                        class="group relative grid grid-rows-[auto_1fr_auto] overflow-hidden rounded-lg bg-gradient-to-br from-[#42b883]/10 to-[#35495e]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(66,184,131,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(66,184,131,0.5)] dark:from-[#42b883]/20 dark:to-[#35495e]/20"
                    >
                        <div class="mb-3 flex items-center gap-3">
                            ...
                            <h3 class="text-lg font-semibold text-[#35495e] dark:text-[#42b883]">Vue.js</h3>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            The progressive JavaScript framework for building modern, reactive user interfaces. Vue 3 offers the Composition API,
                            improved performance, and better TypeScript support.
                        </p>
                        <a
                    ...
                    <div
                        class="group relative grid grid-rows-[auto_1fr_auto] overflow-hidden rounded-lg bg-gradient-to-br from-[#9553e9]/10 to-[#6c2bd9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(149,83,233,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(149,83,233,0.5)] dark:from-[#9553e9]/20 dark:to-[#6c2bd9]/20"
                    >
                        <div class="mb-3 flex items-center gap-3">
                            <svg class="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                                <defs>
                                    <linearGradient id="SVGqdAbMSVr" x1="0" x2="128" y1="64" y2="64" gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#9553e9" />
                                        <stop offset="1" stop-color="#6d74ed" />
                                    </linearGradient>
                                </defs>
                                <path
                                    fill="url(#SVGqdAbMSVr)"
                                    d="M92.433 28.433H55.625L91.192 64L55.625 99.567h36.808L128 64zm-55.625 0H0L35.567 64L0 99.567h36.808L72.375 64z"
                                />
                            </svg>
                            <h3 class="text-lg font-semibold text-[#6c2bd9] dark:text-[#9553e9]">Inertia.js</h3>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            The modern monolith approach. Build single-page applications without the API complexity. Inertia seamlessly bridges
                            Laravel and Vue with server-side routing.
                        </p>
                        <a
                    ...
                    <div
                        class="group relative grid grid-rows-[auto_1fr_auto] overflow-hidden rounded-lg bg-gradient-to-br from-[#06b6d4]/10 to-[#0ea5e9]/10 p-6 shadow-[inset_0px_0px_0px_1px_rgba(6,182,212,0.3)] transition-all hover:shadow-[inset_0px_0px_0px_2px_rgba(6,182,212,0.5)] dark:from-[#06b6d4]/20 dark:to-[#0ea5e9]/20"
                    >
                        <div class="mb-3 flex items-center gap-3">
                            ...
                            <h3 class="text-lg font-semibold text-[#0ea5e9] dark:text-[#06b6d4]">Tailwind CSS</h3>
                        </div>
                        <p class="mb-4 text-sm leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            A utility-first CSS framework for rapid UI development. Build custom designs without leaving your HTML. Tailwind 4 brings
                            improved performance and native cascade layers.
                        </p>
                        <a
